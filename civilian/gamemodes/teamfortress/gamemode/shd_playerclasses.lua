...
function GM:RegisterPlayerClass(name, tbl)
	...
	--[[if LocalPlayer():Team()==1 then
		...
		print("AEEATEYAHEATYEATDTIME TIME")]]--

--end
	--if self.TeamNum==4 then
		local mdl2 = "models/player/"..(tbl.ModelName or "scout")..".mdl"
		local mdl = "models/bots/"..(tbl.ModelName or "scout").."/bot_"..(tbl.ModelName or "scout")..".mdl"
	--else
	--local mdl = "models/player/"..(tbl.ModelName or "scout")..".mdl"
--end
util.PrecacheModel(mdl2)
	--else
	--local mdl = "models/player/"..(tbl.ModelName or "scout")..".mdl"
--end
...
function meta:SetPlayerClass(class)
	...
	print(self:GetPlayerClass())
		print(self:GetPlayerClass())
		if self:GetPlayerClass() == "femalescout" then 
			c.Model = "models/femalescout/player/scout.mdl"
		elseif self:GetPlayerClass() == "merasmus" then 
			c.Model = "models/bots/merasmus/merasmus.mdl"
		else
			if self:Team()==1 then

		c.Model = "models/player/"..(c.ModelName or "scout")..".mdl"
		elseif self:Team()==2 then
			c.Model = "models/player/"..(c.ModelName)..".mdl"
			elseif self:Team()==3 then
				...
				if self:GetPlayerClass()=="scout" then
					print("ROBOTS!!!")
c.Model = "models/bots/scout/bot_scout.mdl"
else
	print("NO")
	c.Model = "models/bots/"..(c.ModelName).."/bot_"..(c.ModelName)..".mdl"
	end
			else
		print("AEEATEYAHEATYEATDTIME TIME")
		c.Model = "models/player/"..(c.ModelName or "scout")..".mdl"
