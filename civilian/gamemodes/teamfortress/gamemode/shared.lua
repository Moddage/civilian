...
function GM:CreateTeams()
	...
	team.SetUp(TEAM_GRY, "GRAY Team", Color(172, 172, 172))
	SetTeamSecondaryColor(TEAM_GRY, Color(172, 172, 172))
	team.SetSpawnPoint(TEAM_GRY, "info_player_start")
...
function GM:ShouldCollide(ent1, ent2)
	...
	if (ent1:IsPlayer() or ent2:IsPlayer()) and (t1==TEAM_RED or t1==TEAM_BLU or t1==TEAM_GRY) and t1==t2 then
		return false
	end
